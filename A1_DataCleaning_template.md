...
is the project directory.
    ...
    # Setting WD
    setwd("C:/Users/louis/OneDrive - Aarhus universitet/AU Onedrive - RIGTIG/- 3. Semester/Experimental Methods III/Classes/Assignment 1/Assignment-1")
...
absolute best method.
    ...
    #Test
    ggplot(demo, aes(Child.ID, Visit)) +
      geom_bar(stat = "identity", position = "dodge")

![](A1_DataCleaning_template_files/figure-markdown_strict/unnamed-chunk-3-1.png)
